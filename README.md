...
The content of this repository is suitable for those completely new to WEkEO, Python, R, Copernicus data and hosted processing environments.
...
You can also use this code on your own computer/Jupyter Lab server. To do so, clone the repository and install the required dependencies (Python or R libraries) as listed in each case study.
